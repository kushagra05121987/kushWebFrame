...
// spl_autoload_register can take multiple autoloading methods which are called using FIFO
set_include_path("./include");
// include_path is same as set_include_path, works as a base dir for require, include, file, file_get_contents
...
echo "------------------ ";
br();
// Used to manually call a specific call by using registered autoloaders
...
$comp1 = $comp5 = new comp1(10,20,30,40,50);
$comp6 = new comp1(0,30,10,140,5);
